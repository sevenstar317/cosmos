                            ...
                            <div class="col col-sm-6 form-column">
                                ...
                                <div class="form-group">
                                    <div class="input-group date" id="">
                                        <input type="text"  value="{{$user->getBirthday()}}" readonly  class="form-control input-lg" id="datepn" placeholder="Birth Date">
                            ...
                            <div class="col col-sm-6 form-column">
                                ...
                                <div class="form-group">
                                    <div class="input-group date" id="datetimepicker2">
                                        <input type="text"  name="birth_month"  class="form-control input-lg" {{old('birth_month')?:$second_user->birth_month}} required placeholder="Birth Date">
                                                <span class="input-group-addon">
                                                    <span class="fa fa-chevron-down"></span>
                                                </span>
                                    </div>
