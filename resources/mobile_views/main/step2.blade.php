    ...
    <section class="hero-section flow-section select-sign">
        <div class="container">
            <div class="flow-inner text-center">
                ...
                <p class="flow-title">Select Your Gender</p>
                <form class="form" method="GET" action="{{ action('MainController@step3') }}">
                    {{ Form::hidden('registration_token', $registration_token) }}
                    <ul class="row list-inline list-unstyled radios-list gender-list">
                        <li class="col col-sm-offset-4 col-sm-2">
                            <div class="radio active">
                                <label>
                                    <input type="radio" name="sex" id="optionsRadios2" value="Female"/>
                                    <img class="img-responsive" src="../images/gender-female.png" alt=""/>
                                    <span>Female</span>
                                </label>
                            </div>
                        </li>
                        <li class="col col-sm-2">
                            <div class="radio">
                                <label>
                                    ...
                                    <img class="img-responsive" src="../images/gender-male.png" alt=""/>
                                    <span>Male</span>
                                </label>
                            </div>
                        </li>
