...
<head>
    ...
    <link href="{{ elixir('css/style_mobile.css') }}" rel="stylesheet">
        ...
        <div class="container">
            <nav class="navbar" role="navigation">
                <div class="container-fluid">
                    ...
                    <div class="navbar-collapse collapse" id="menu-id" aria-expanded="false">
                        <ul class="nav navbar-nav navbar-right main-menu">
                            <li class="time-left">
                                <div class="btn btn-sm time"><i class="fa fa-clock-o"></i>  {{Auth::user()->minutes_balance}}</div>
                            </li>
                            <li class="time-add">
                                <button class="btn btn-sm btn-primary time" id="<?php  if(isset(Auth::user()->paymentInfo)){ echo 'add_funds';} else { echo 'add_payment_info';} ?>">
                                    <i class="fa fa-plus"></i> Add minutes
                                </button>
                            </li>
                            <li>
                                <a class="btn btn-sm btn-primary sign-in" href="{{ url('/logout') }}">Sign out</a>
                            </li>
                        </ul>
                    </div>
                ...
                <div class="clearfix text-center selectors">
                    <div class="col col-xs-4">
                        <a href="" id="add_5_minutes" class="add-selector">
                            ...
                            <span class="price" style="font-size: 11px !important;">$29.95</span>
                        </a>
                    </div>
                    <div class="col col-xs-4">
                        <a href="" id="add_10_minutes" class="add-selector">
                            ...
                            <span class="hover">+ ADD</span>
                            <span class="price" style="font-size: 11px !important;">$39.95</span>
                        </a>
                    </div>
                    <div class="col col-xs-4">
                        <a href="" id="add_15_minutes" class="add-selector">
                            ...
                            <span class="hover">+ ADD</span>
                            <span class="price" style="font-size: 11px !important;">$44.95</span>
                        </a>
                    </div>
                </div>
            </div>
        ...
        <div class="modal-content text-center">
            ...
            <div class="modal-subbody">
                <div class="clearfix text-left">
                    <ul class="col col-xs-6 list-unstyled">
