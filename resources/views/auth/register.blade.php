            ...
            <div class="signup-form-wrapper">
                ...
                <div class="signup-inner">
                    <form class="signup-form" role="form" method="POST" autocomplete="off" action="{{ url('/register') }}">
                        ...
                        <div class=" row form-group{{ $errors->has('birth_day') ? ' has-error' : '' }}" style="margin-left: 0px;  margin-right: 0px;">
                            <div class="col-md-3" style="padding: 0px;padding-top: 5px;padding-bottom: 5px; ">
                            ...
                            <div class="col-md-4" style="padding: 0px;padding-top: 5px;padding-bottom: 5px;">
                        ...
                        <div class=" row form-group{{ $errors->has('state') ? ' has-error' : '' }}" style="margin-left: 0px;  margin-right: 0px;">
                            <div class="col-md-6" style="padding: 0px;padding-top: 5px;padding-bottom: 5px;">
                        ...
                        <div class="checkbox">
                            <label>
                                <input type="checkbox" style="position:relative;margin-left: 0px;"/> I want to receive special offers, coupons and tips via email.
                            </label>
                        </div>
                        <div class="checkbox">
                            <label>
                                <input type="checkbox" required style="position:relative;margin-left: 0px;"/>  I have read and agree to the Live Cosmos member terms
                                and conditions.
                            </label>
                        </div>
                        <br/>
